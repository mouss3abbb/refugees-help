          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  SizedBox(width: 100,),
                  Text(' مواعيد العمل من 9 صباحا الى 5 مساءا ', style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                      color: Colors.white
                  ),),
            ...
            Padding(
              ...
              child: Row(
                  mainAxisAlignment: MainAxisAlignment.end,
                  children: [
                    Text('المرتب 4-5 الاف شهريا', style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        color: Colors.white
                    ),),
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: [
                  Text('  خبرة لا تقل عن ٣ سنوات في مكاتب المحاماة  -', style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                      color: Colors.white
                  ),)
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.end,
              children: [
                Text('  سنتان-5 سنوات خبرة -', style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                    color: Colors.white
                ),)
