          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                  mainAxisAlignment: MainAxisAlignment.end,
                  children: [
                    Text('المرتب حسب الخبرة الهندسية', style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        color: Colors.white
                    ),),
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: [
                  Text('  يحافظ على الضوابط المحاسبية  -', style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                      color: Colors.white
                  ),)
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.end,
              children: [
                Text('المؤهل للعمل بالشركة حاصلا على شهادة البكالوريوس -',
                  style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                      color: Colors.white
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.end,
              children: [
                Text('  القدرة على التعاون مع فرق العمل بهدف رضا العملاء -', style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                    color: Colors.white
                ),)
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.end,
              children: [
                Text(' القدرة على الالتزام بالمواعيد النهائية لتسليم المشاريع -', style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                    color: Colors.white
                ),)
