          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  //SizedBox(width: 100,),
                  Text('مواعيد العمل من 7 صباحا الى 5 مساءا', style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                      color: Colors.white
                  ),),
            ...
            Padding(
              ...
              child: Row(
                  mainAxisAlignment: MainAxisAlignment.end,
                  children: [
                    Text('المرتب 5 الاف شهريا', style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        color: Colors.white
                    ),),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.end,
              children: [
                Text('وضع وتنفيذ وتعديل وتوثيق نظم حفظ السجلات والمحاسبة -',
                  style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                      color: Colors.white
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.end,
              children: [
                Text('  سنتان-10 سنوات خبرة -', style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                    color: Colors.white
                ),)
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.end,
              children: [
                Text(' مؤهل عالي -', style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                    color: Colors.white
                ),)
