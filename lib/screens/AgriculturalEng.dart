          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                  mainAxisAlignment: MainAxisAlignment.end,
                  children: [
                    Text('المرتب 4 الاف شهريا', style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        color: Colors.white
                    ),),
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: [
                  Text('  إجادة التعامل مع جهاز سكادا  -', style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                      color: Colors.white
                  ),)
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.end,
              children: [
                Text('إجادة تفرقة أنواع العلف وجودتها -',
                  style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                      color: Colors.white
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.end,
              children: [
                Text('  سنتان-3 سنوات خبرة -', style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                    color: Colors.white
                ),)
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.end,
              children: [
                Text(' التفرقة بين الخامات من حيث جودتها -', style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                    color: Colors.white
                ),)
